/* BGP BI — gerado por build-data.cjs em 2026-06-30T06:08:07.434Z */
...
const META = {
  ...
  "fetched_at": "2026-06-30T06:08:07.125Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const CONTAS = [
  {
    ...
    "despesa": 1327389.74,
    "count": 1297,
    "liquido": 148065.52000000002,
    "margem": 10.035242952741246
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1381896.2599999993,
  "custos_operacionais": 981846.1800000009,
  "margem_contribuicao": 400050.07999999844,
  "margem_contribuicao_pct": 28.94935687864143,
  "despesas_operacionais": 362165.8899999996,
  "resultado_operacional": 37884.18999999884,
  "resultado_operacional_pct": 2.74146410961405,
  "investimento": -41500.95,
  "financiamento": 62480.78,
  "variacao_caixa": 58864.01999999884
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
  ...
  {
    "receita": 294625.39999999997,
    "custo": -203232.02000000005,
    "despesa": -72405.89000000003,
...
const SEGMENTS = {
  "realizado": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 857763.3800000001
      },
      {
        "name": "SHEIN",
        "value": 213876.63000000006
      },
      {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1493703.8499999999,
      "TOTAL_DESPESA": 1434839.83,
      "VALOR_LIQUIDO": 58864.019999999786,
      "MARGEM_LIQUIDA": 3.940809284250007,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.189999999944,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    "MONTH_DATA": [
      ...
      },
      {
        "m": "julho",
        "receita": 297745,
        "despesa": 254322.8899999999
      },
      {
        "m": "agosto",
        "receita": 290100,
        "despesa": 143237.23000000004
      },
      {
        "m": "setembro",
        "receita": 267900,
        "despesa": 99252.57999999999
      },
      {
        "m": "outubro",
        "receita": 0,
    ...
    "KPIS": {
      "TOTAL_RECEITA": 866554.02,
      "TOTAL_DESPESA": 531959.57,
      "VALOR_LIQUIDO": 334594.45000000007,
      "MARGEM_LIQUIDA": 38.61207060120731,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 1280963.3800000001
      },
      {
        "name": "SHEIN",
        "value": 348502.00000000006
      },
      {
        "name": "MERCADO LIVRE",
        "value": 239800
    ...
    "KPIS": {
      "TOTAL_RECEITA": 2360257.87,
      "TOTAL_DESPESA": 1966799.4000000001,
      "VALOR_LIQUIDO": 393458.47,
      "MARGEM_LIQUIDA": 16.670147571629535,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.189999999944,
        31353.859999999986,
    ...
    "COMP_DATA": [
      ...
      },
      {
        ...
        "parent": "Receita",
        "d1": 554105.9599999998,
        "d2": 787985.6900000004
      },
      {
        "tipo": "Receita com vendas",
        "parent": "Receita",
        "d1": 8079.6500000000015,
        "d2": 15769.480000000001
      },
      {
        "tipo": "Receita por troca/adição de produtos em pedido",
        "parent": "Receita",
