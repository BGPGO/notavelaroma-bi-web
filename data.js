/* BGP BI — gerado por build-data.cjs em 2026-07-27T16:27:28.722Z */
...
const META = {
  ...
  "fetched_at": "2026-07-27T16:27:26.466Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const POSICAO_CAIXA = [
  {
    ...
    "value": 115869.3999999999
  },
  {
    "name": "A receber (futuro)",
    "value": 1119858.1400000001
  },
  {
    "name": "A pagar (futuro)",
    "value": 614700.9500000001
  }
];
const COMPOSICAO_DESPESA = [
  {
    "name": "Compra de matéria-prima",
    "value": 896804.6200000013,
    "color": "#2dd4bf"
  },
  {
...
const CONTAS = [
  {
    ...
    "label": "01 - SICREDI",
    "receita": 1813778.14,
    "despesa": 1586666.3099999996,
    "count": 1518,
    "liquido": 227111.8300000003,
    "margem": 12.521477957607335
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1724719.1399999992,
  "custos_operacionais": 1150420.2000000004,
  "margem_contribuicao": 574298.9399999988,
  "margem_contribuicao_pct": 33.298113685918686,
  "despesas_operacionais": 436984.90999999945,
  "resultado_operacional": 137314.02999999933,
  "resultado_operacional_pct": 7.961529898717272,
  "investimento": -58170.740000000005,
  "financiamento": 36726.11,
  "variacao_caixa": 115869.39999999932
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
...
const SEGMENTS = {
  "realizado": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 1004288.9400000002
      },
      {
        "name": "SHEIN",
        "value": 241152.52000000008
      },
      {
        "name": "TIKTOK",
        "value": 188119.77000000002
      },
      {
        "name": "MERCADO LIVRE",
        "value": 172700
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1837206.52,
      "TOTAL_DESPESA": 1721337.12,
      "VALOR_LIQUIDO": 115869.3999999999,
      "MARGEM_LIQUIDA": 6.306824994285341,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1119858.1400000001,
      "TOTAL_DESPESA": 614700.9500000001,
      "VALOR_LIQUIDO": 505157.19000000006,
      "MARGEM_LIQUIDA": 45.10903407819137,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 2957064.66,
      "TOTAL_DESPESA": 2336038.07,
      "VALOR_LIQUIDO": 621026.5900000003,
      "MARGEM_LIQUIDA": 21.00145453025029,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
