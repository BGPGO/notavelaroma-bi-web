/* BGP BI — gerado por build-data.cjs em 2026-07-21T06:16:00.911Z */
...
const META = {
  ...
  "fetched_at": "2026-07-21T06:15:58.567Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const POSICAO_CAIXA = [
  {
    ...
    "value": 70844.9600000002
  },
  {
    "name": "A receber (futuro)",
    "value": 822455.8200000001
  },
  {
    "name": "A pagar (futuro)",
    "value": 655769.0399999999
  }
];
const COMPOSICAO_DESPESA = [
  {
    "name": "Compra de matéria-prima",
    "value": 868616.5400000011,
    "color": "#2dd4bf"
  },
  {
...
const CONTAS = [
  {
    "slug": "01_sicredi",
    "label": "01 - SICREDI",
    "receita": 1717689.8199999998,
    "despesa": 1535602.43,
    "count": 1479,
    "liquido": 182087.3899999999,
    "margem": 10.600714277971322
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1628630.8199999991,
  "custos_operacionais": 1116282.980000001,
  "margem_contribuicao": 512347.8399999982,
  "margem_contribuicao_pct": 31.45880783466928,
  "despesas_operacionais": 420058.2499999995,
  "resultado_operacional": 92289.58999999875,
  "resultado_operacional_pct": 5.666697993594324,
  "investimento": -58170.74,
  "financiamento": 36726.11,
  "variacao_caixa": 70844.95999999874
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
  ...
  {
    "receita": 218941.16999999998,
    "custo": -133913.3,
    "despesa": -54090.850000000006,
...
const SEGMENTS = {
  "realizado": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 965346.9300000002
      },
      {
        "name": "SHEIN",
        "value": 237770.72000000012
      },
      {
        "name": "MERCADO LIVRE",
        "value": 160700
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1741118.2,
      "TOTAL_DESPESA": 1670273.2399999998,
      "VALOR_LIQUIDO": 70844.9600000002,
      "MARGEM_LIQUIDA": 4.068934550221817,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19000000006,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 822455.8200000001,
      "TOTAL_DESPESA": 655769.0399999999,
      "VALOR_LIQUIDO": 166686.78000000014,
      "MARGEM_LIQUIDA": 20.26695853401586,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 1351746.9300000002
      },
      {
        "name": "SHEIN",
        "value": 353244.77000000014
      },
      {
        "name": "TIKTOK",
        "value": 330395.26
    ...
    "KPIS": {
      "TOTAL_RECEITA": 2563574.02,
      "TOTAL_DESPESA": 2326042.28,
      "VALOR_LIQUIDO": 237531.74000000022,
      "MARGEM_LIQUIDA": 9.265647808367172,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19000000006,
        31353.859999999986,
