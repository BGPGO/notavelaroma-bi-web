/* BGP BI — gerado por build-data.cjs em 2026-06-29T06:08:51.568Z */
...
const META = {
  ...
  "fetched_at": "2026-06-29T06:08:51.366Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const CONTAS = [
  {
    ...
    "despesa": 1323356.55,
    "count": 1289,
    "liquido": 135908.61999999988,
    "margem": 9.313497148705324
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1365706.1699999992,
  "custos_operacionais": 979245.7000000009,
  "margem_contribuicao": 386460.46999999834,
  "margem_contribuicao_pct": 28.29748290585804,
  "despesas_operacionais": 360733.1799999996,
  "resultado_operacional": 25727.289999998757,
  "resultado_operacional_pct": 1.8838085794105164,
  "investimento": -41500.95,
  "financiamento": 62480.78,
  "variacao_caixa": 46707.11999999876
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
...
const SEGMENTS = {
  "realizado": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1477513.76,
      "TOTAL_DESPESA": 1430806.64,
      "VALOR_LIQUIDO": 46707.12000000011,
      "MARGEM_LIQUIDA": 3.161196955620915,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.189999999944,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 851228.65,
      "TOTAL_DESPESA": 532922.69,
      "VALOR_LIQUIDO": 318305.9600000001,
      "MARGEM_LIQUIDA": 37.39370849418662,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 2328742.41,
      "TOTAL_DESPESA": 1963729.33,
      "VALOR_LIQUIDO": 365013.0800000001,
      "MARGEM_LIQUIDA": 15.674257420338733,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.189999999944,
        31353.859999999986,
    ...
    "COMP_DATA": [
      ...
      },
      {
        ...
        "parent": "Receita",
        "d1": 554105.9599999998,
        "d2": 785620.2300000004
      },
      {
        "tipo": "Receita com vendas",
        "parent": "Receita",
        "d1": 8079.6500000000015,
        "d2": 15719.480000000001
      },
      {
        "tipo": "Receita por troca/adição de produtos em pedido",
        "parent": "Receita",
