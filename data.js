/* BGP BI — gerado por build-data.cjs em 2026-07-28T06:34:40.731Z */
...
const META = {
  ...
  "fetched_at": "2026-07-28T06:34:38.679Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const POSICAO_CAIXA = [
  {
    ...
    "value": 129635.86999999988
  },
  {
    "name": "A receber (futuro)",
    "value": 1114648.1400000001
  },
  {
    "name": "A pagar (futuro)",
    "value": 615023.48
...
const CONTAS = [
  {
    "slug": "01_sicredi",
    "label": "01 - SICREDI",
    "receita": 1829139.5599999998,
    "despesa": 1588261.2599999995,
    "count": 1524,
    "liquido": 240878.30000000028,
    "margem": 13.168940482595012
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1740080.5599999991,
  "custos_operacionais": 1151449.9400000004,
  "margem_contribuicao": 588630.6199999987,
  "margem_contribuicao_pct": 33.827779789689686,
  "despesas_operacionais": 437550.1199999995,
  "resultado_operacional": 151080.49999999924,
  "resultado_operacional_pct": 8.682385371858835,
  "investimento": -58170.740000000005,
  "financiamento": 36726.11,
  "variacao_caixa": 129635.86999999924
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
  ...
  {
    "receita": 330390.91,
    "custo": -169080.25999999992,
    "despesa": -71582.72000000002,
...
const SEGMENTS = {
  "realizado": {
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 1010758.2300000002
      },
      {
        "name": "SHEIN",
        "value": 245393.23000000007
      },
      {
        "name": "TIKTOK",
        "value": 192771.19000000003
      },
      {
        "name": "MERCADO LIVRE",
        "value": 172700
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1852567.94,
      "TOTAL_DESPESA": 1722932.07,
      "VALOR_LIQUIDO": 129635.86999999988,
      "MARGEM_LIQUIDA": 6.997631082830888,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    "MONTH_DATA": [
      ...
      },
      {
        "m": "setembro",
        "receita": 357000,
        "despesa": 176376.25999999998
      },
      {
        "m": "outubro",
        "receita": 328500,
        "despesa": 104262.19000000002
      },
      {
        "m": "novembro",
        "receita": 0,
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1114648.1400000001,
      "TOTAL_DESPESA": 615023.48,
      "VALOR_LIQUIDO": 499624.66000000015,
      "MARGEM_LIQUIDA": 44.82353148680624,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    "MONTH_DATA": [
      ...
      {
        "m": "julho",
        "receita": 386609.79999999993,
        "despesa": 291281.62999999995
      },
      {
        "m": "agosto",
        "receita": 373145,
    ...
    "RECEITA_CLIENTES": [
      {
        "name": "SHOPEE",
        "value": 1516758.2300000002
      },
      {
        "name": "TIKTOK",
        "value": 560771.1900000001
      },
      {
        "name": "SHEIN",
        "value": 332152.5200000001
      },
      {
        "name": "MERCADO LIVRE",
        "value": 276700
    ...
    "KPIS": {
      "TOTAL_RECEITA": 2967216.08,
      "TOTAL_DESPESA": 2337955.55,
      "VALOR_LIQUIDO": 629260.5300000003,
      "MARGEM_LIQUIDA": 21.207101641212468,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
