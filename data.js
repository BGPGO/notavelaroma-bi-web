/* BGP BI — gerado por build-data.cjs em 2026-07-31T06:48:42.651Z */
...
const META = {
  ...
  "fetched_at": "2026-07-31T06:48:40.780Z",
  "ref_year": 2026,
  "counts": {
    "contas_pagar": 0,
    "contas_receber": 0,
...
const CONTAS = [
  {
    "slug": "01_sicredi",
    "label": "01 - SICREDI",
    "receita": 1866350.2799999996,
    "despesa": 1610308.0499999993,
    "count": 1547,
    "liquido": 256042.2300000002,
    "margem": 13.71887328674445
  },
  {
    "slug": "02_bradesco",
    "label": "02 - BRADESCO",
...
const DRE_INDICATORS = {
  "receitas_operacionais": 1777291.2799999989,
  "custos_operacionais": 1170111.3000000003,
  "margem_contribuicao": 607179.9799999986,
  "margem_contribuicao_pct": 34.163222811738486,
  "despesas_operacionais": 440935.54999999946,
  "resultado_operacional": 166244.42999999912,
  "resultado_operacional_pct": 9.353808904075601,
  "investimento": -58170.740000000005,
  "financiamento": 36726.11,
  "variacao_caixa": 144799.79999999912
};
const DRE_MONTHLY = [
  {
    "receita": 124722.78,
  ...
  {
    "receita": 367601.62999999983,
    "custo": -187741.6199999999,
    "despesa": -74968.15000000001,
...
const SEGMENTS = {
  "realizado": {
    ...
    "RECEITA_CLIENTES": [
      ...
      {
        "name": "AMAZON",
        "value": 62932.70999999999
      },
      {
        "name": "VENDA FÍSICA",
        "value": 5476.100000000002
      },
      {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1889778.66,
      "TOTAL_DESPESA": 1744978.86,
      "VALOR_LIQUIDO": 144799.7999999998,
      "MARGEM_LIQUIDA": 7.662262415430165,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
  ...
  "a_pagar_receber": {
    ...
    "KPIS": {
      "TOTAL_RECEITA": 1123162.55,
      "TOTAL_DESPESA": 770264.5399999999,
      "VALOR_LIQUIDO": 352898.0100000001,
      "MARGEM_LIQUIDA": 31.420029985864478,
      "VALOR_LIQ_SERIES": [
        0,
        0,
        0,
  ...
  "tudo": {
    ...
    "RECEITA_CLIENTES": [
      ...
      {
        "name": "AMAZON",
        "value": 110294.29999999999
      },
      {
        "name": "VENDA FÍSICA",
        "value": 5621.100000000002
      },
      {
        "name": "SAMUEL ANTONIO DE SOUZA MARTINS",
        "value": 4550
    ...
    "KPIS": {
      "TOTAL_RECEITA": 3012941.21,
      "TOTAL_DESPESA": 2515243.4,
      "VALOR_LIQUIDO": 497697.81000000006,
      "MARGEM_LIQUIDA": 16.518669808363107,
      "VALOR_LIQ_SERIES": [
        7018.999999999971,
        37001.19,
        31353.859999999986,
